...
%% Configurations
audioInterfaceName = 'UMC'; %'ASIO4ALL';
...
if isequal(mode, 'persistentFormantShift')
    ...
    params = getAudapterDefaultParamsPitch(gender);
...
elseif isequal(mode, 'focalFormantShift');
    ...
    ostFN = 'C:\speechres\AudapterStudies\audapter_matlab\example_data\focal_fmt_pert.ost';
    pcfFN = 'C:\speechres\AudapterStudies\audapter_matlab\example_data\focal_fmt_pert.pcf';
...
elseif isequal(mode, 'twoShortPitchShifts');
    ostFN = 'C:\speechres\AudapterStudies\audapter_matlab\example_data\two_blips.ost';
    pcfFN = 'C:\speechres\AudapterStudies\audapter_matlab\example_data\two_pitch_shifts.pcf';
    
    ostFN = 'C:\speechres\AudapterStudies\audapter_matlab\example_data\formant_reflex_1.ost';
    pcfFN = 'C:\speechres\AudapterStudies\audapter_matlab\example_data\formant_reflex_UP.pcf';
    ...
    params = getAudapterDefaultParamsPitch('female');
    params.bShift = 1;
