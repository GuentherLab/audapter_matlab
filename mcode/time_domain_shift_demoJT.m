...
%params.timeDomainPitchShiftSchedule = [0, 1.0; 1, 1.0; 2, 0.9439]; %Shift
%down 100 cents; 1 sec delay; decrease linearly to max pert at 2 sec
%params.timeDomainPitchShiftSchedule = [0, 1.0; .5, 1.0; 1, 1.0595]; %Shift
%up 100 cents, .5 sec delay, linear ramp to max at 1 sec
params.timeDomainPitchShiftSchedule = [0, 1.0; .5, 1.0; 1, 1.2599]; %Shift
%up 400 cents; .5 sec delay; linear increase to max pert at 1 sec
